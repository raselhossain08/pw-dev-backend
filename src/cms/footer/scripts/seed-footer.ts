...
async function seedFooter() {
    ...
    try {
        ...
        console.log('   2. Access the footer API: GET http://localhost:5000/api/cms/footer/active');
        console.log('   3. Upload a logo (optional): POST http://localhost:5000/api/cms/footer/{id}/logo');
        console.log('   4. Your frontend will now fetch this footer data automatically!\n');
